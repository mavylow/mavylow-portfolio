...
export const ProjectCard = ({
  ...
  <div className="card flex flex-col relative w-[260px] min-h-[340px] h-fit border justify-between border-gray-400 rounded-md  items-center pt-2 pb-[1vw]  laptop:w-[30vw]">
